...
labyrinth_zone zoneID		$12
marble_zone zoneID			$13
star_light_zone zoneID		$14
spring_yard_zone zoneID		$15
scrap_brain_zone zoneID		$16
zone_17 zoneID			$17
zone_18 zoneID			$18
zone_19 zoneID			$19
zone_1A zoneID			$1A
...
PalID_GHZ =	id(PalPtr_GHZ) ; 10
PalID_LZ =	id(PalPtr_LZ) ; 10
PalID_MZ =	id(PalPtr_MZ) ; 10
PalID_SLZ =	id(PalPtr_SLZ) ; 10
PalID_SYZ =	id(PalPtr_SYZ) ; 10
PalID_SBZ1 =	id(PalPtr_SBZ1) ; 10
PalID_SBZ2 =	id(PalPtr_SBZ2) ; 10
PalID_SBZ3 =	id(PalPtr_SBZ3) ; 10
PalID_17 =	id(PalPtr_17) ; 10
PalID_18 =	id(PalPtr_18) ; 10
PalID_19 =	id(PalPtr_19) ; 10
PalID_1A =	id(PalPtr_1A) ; 10
PalID_1B =	id(PalPtr_1B) ; 10
PalID_1C =	id(PalPtr_1C) ; 10
PalID_1D =	id(PalPtr_1D) ; 10
PalID_1E =	id(PalPtr_1E) ; 10
PalID_1F =	id(PalPtr_1F) ; 10
PalID_20 =	id(PalPtr_20) ; 10
PalID_LZ_U =	id(PalPtr_LZ_U) ; 10
PalID_SBZ3_U =	id(PalPtr_SBZ3_U) ; 10
...
PLCID_Ghz1 =	        id(PLCptr_Ghz1) ; 42
PLCID_Ghz2 =	        id(PLCptr_Ghz2) ; 42
...
LevSel_Page:		ds.b	1	; Written to near loc_175EA, never read from
f_conveyrev:			ds.b	1	; Written to near loc_175EA, never read from
